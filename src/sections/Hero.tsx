        ...
        <section className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip" id={id}>
            ...
            <div className="container relative z-10">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-8">
                    ...
                    <a href={"#" + contactSectionId} className="scroll-smooth">
                        <button className="inline-flex items-center gap-2 px-6 h-12 border border-white text-gray-900 bg-white rounded-xl hover:bg-gray-100 transition">
                            <span>👋</span>
